    ...
    <main class="emms22__pre-event">
        ...
        <div class="emms22__pre-event__calendar">
            <div class="emms22__container--lg">
                        ...
                        <div class="emms22__pre-event__calendar__event-list__event__card">
                            <div class="emms22__pre-event__calendar__event-list__event__card__speaker">
                                ...
                                <div class="emms22__pre-event__calendar__event-list__event__card__speaker__text">
                                    ...
                                    <ul>
                                        <li><a href=""><img src="../html/<?= VERSION ?>/img/icons/Twitter.svg"
                                                    alt=""></a></li>
                                        <li><a href=""><img src="../html/<?= VERSION ?>/img/icons/LinkedIn.svg"
                                                    alt=""></a></li>
                                        <li><a href=""><img src="../html/<?= VERSION ?>/img/icons/Instagram.svg"
                                                    alt=""></a></li>
                                        <li><a href=""><img src="../html/<?= VERSION ?>/img/icons/Facebook.svg"
                                                    alt=""></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="emms22__pre-event__calendar__event-list__event__card__description">
                                <p>Evolución del Retail: Experiencia y Comportamiento del Usuario 360° hasta la
                                    actualidad.</p>
                            </div>
                ...
                <ul class="emms22__pre-event__calendar__event-list emms22__fade-in emms22__show-mb main-carousel"
