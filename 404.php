    ...
    <nav class="emms22__header">
      <div class="emms22__container--lg">
        <div class="emms22__header__logo">
          <a href="index.php#inicio"><img src="../img/logo-emms.png?version=<?= VERSION ?>" alt="Emms 2022"
              id="logo-emms-404"></a>
        </div>
      </div>
    </nav>
      ...
      <div class="emms22__container--lg ">
        <div class="emms22__404__container">
          ...
          <div class="emms22__404__error error-404-message">
            ...
            <button type="button" class="emms22__404__button" id="error-404-btn"
