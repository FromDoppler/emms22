...
<body style="margin:0; padding:0;"><span class="preheader"
    style="display: none !important; visibility: hidden; opacity: 0; color: transparent; height: 0; width: 0;">Ya puedes revivir el evento más esperado por la Comunidad del Marketing
            ...
            <tr>
              <td align="center" valign="top">
                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                  ...
                  <tr>
                    <td height="50" style="font-size:56px; line-height:50px;">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" valign="top">
                  ...
                  <tr>
                    <td align="center" valign="top" style="font-family: Helvetica, Arial,sans-serif;font-size: 15px;line-height: 20px;color:#555845;font-weight: 400;"
                    class="dm-text-light">
                      <p style="margin:0; font-size: 31px;line-height: 34px;color:#333333;font-weight: 700;">
                  ...
                  <tr>
                    <td align="center" valign="top" style="font-family: Helvetica, Arial,sans-serif;font-size: 15px;line-height: 20px;color:#555845;font-weight: 400;"
                    class="dm-text-light">
                    <p style="margin:0; font-size: 15px;line-height: 20px;color:#333333;font-weight: 700;">
                  ...
                  <tr>
                    ...
                    <p class="paragraph" style="margin:0; font-size: 14px; line-height: 19px; color: #333333;">El Evento más esperado por la Comunidad del Marketing fue el 8, 9 y 10 de Noviembre. Asistieron más de 50.000 personas y ahora tú eres parte. <strong>¡Puedes revivirlo cuando quieras!</strong>
                      ...
                      <p style="margin:0;font-size: 20px;">&nbsp;</p>
                      <p class="paragraph" style="margin:0; font-size: 14px; line-height: 19px; color: #333333;">Además, recibirás contenido exclusivo, invitaciones a capacitaciones, certificaciones gratuitas y beneficios únicos.</p>
                  </td>
                  </tr>
                  <tr>
                                                ...
                                                <tr>
                                                  <td
                                                    ...
                                                    <a href="https://goemms.com/?utm_source=fromdoppler&utm_campaign=inbound-postemms2022&utm_medium=email"
                                                      ...
                                                      target="_blank"><span>VER EL EVENTO</span></a>
                                                  </td>
                                                </tr>
                                              </table>
                                              <!--[endif]-->
