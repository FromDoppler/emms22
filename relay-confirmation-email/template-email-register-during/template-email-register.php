            ...
            <tr>
              <td align="center" valign="top">
                <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                  ...
                  <tr>
                    <td height="56" style="font-size:56px; line-height:56px;">&nbsp;</td>
                  </tr>
                  <tr>
                    <td>
                      ...
                      <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                        <tr>
                          ...
                          <th width="420" class="mobile mobile-pt mobile-center" align="left" valign="middle"
                            ...
                            <p class="paragraph"
                              style="margin:0 0 15px 20px; font-size: 31px;line-height: 34px;color:#333333;font-weight: 700;">
                              ¡Gracias por registrarte!
                            </p>
                            <p class="paragraph"
                              style="max-width: 310px; margin:0 0 15px 20px; font-size: 15px;line-height: 20px;color:#333333;font-weight: 700;">
                              TE DAMOS LA BIENVENIDA A UNA NUEVA EDICIÓN DEL EMMS
                            </p>
                            <p class="paragraph" style="margin:0 0 40px 20px; font-size: 14px; line-height: 19px;">Ya eres parte del Evento más esperado por la comunidad del Marketing. Cuando quieras, puedes unirte para acceder a las Conferencias.                            </p>
                            <!-- Button : BEGIN -->
                            <div style="margin:0 0 0 20px;" class="btn-mb">
                              <!--[if mso]>
                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://goemms.com/?utm_source=fromdoppler&utm_campaign=inbound-postemms2022&utm_medium=email" style="height:43px;v-text-anchor:middle;width:175px;" arcsize="50%" strokecolor="#33AD73" strokeweight="1px" fillcolor="#33AD73" >
                                <w:anchorlock/>
                              ...
                              <table cellspacing="0" cellpadding="0">
                                <tr>
                                  <td
                                    style="border-radius: 3px; background-color: #33AD73; color: #ffffff; text-align: center;"
                                    class="button--td">
                                    <a href="https://goemms.com/?utm_source=fromdoppler&utm_campaign=inbound-postemms2022&utm_medium=email"
                                      style="padding: 11px 31px; box-sizing: border-box; color: #ffffff; font-size:15px; font-weight: bold; font-family:sans-serif; text-decoration: none; width:100%; display:inline-block"
                                      target="_blank"><span>ASISTIR AL EVENTO</span></a>
                                  </td>
                                </tr>
                              </table>
                              <!--[endif]-->
                  ...
                  <tr>
                    <td align="center" valign="top"
                      ...
                      class="dm-text-light">
                      <p style="font-size: 14px; line-height: 19px; color: #333333;">Además por ser parte del #EMMS2022 recibirás contenido exclusivo, invitaciones a capacitaciones, certificaciones gratuitas y beneficios únicos.</p>
                    </td>
                  </tr>
                  <tr>
                    <td height="70" style="font-size:81px; line-height:70px;">&nbsp;</td>
                  </tr>
                </table>
              </td>
            </tr>
                    ...
                    <td align="left" style="padding: 25px 0 0;" class="dm-text-light">
                      <p style="
                        ...
                        <a href="https://www.fromdoppler.com" target="_blank"
                          style="text-decoration: none; color: #33AD73;font-weight: bold;" class="link-hover">Doppler
                          LLC</a>. Todos
