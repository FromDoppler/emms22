...
function edt_id(id)
{
  window.location.href='edit_aliados_starter.php?edit_id='+id;
}
function view_id(id)
{
  window.location.href='view_aliados_starter.php?view_id='+id;
}
...
<div id="container">
 ...
 <div id="table-responsive">
    ...
    <tr>
    <th colspan="9"><a href="add_aliados_starter.php">ADD aliados_starter.</a></th>
    </tr>
    <th>id</th>
    <th>name</th>
    <th>image_home</th>
