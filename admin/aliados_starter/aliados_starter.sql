...
CREATE TABLE `aliados_starter` (
  ...
  `title` text COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `title_magnet` text COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `title_learnmore` text COLLATE utf8mb4_general_ci DEFAULT NULL,
