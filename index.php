			...
			<div class="emms22__speakers">
				<div class="emms22__container--md">
					...
					<ul class="emms22__speakers__list">
						...
						<li class="emms22__fade-in">
							<img src="./html/img/speaker-marcos-pueyrredon.png" alt="Marcos Pueyrred&oacute;n">
						...
						<li class="emms22__fade-in">
							<img src="./html/img/speaker-lolo-alvarez-diaz.png" alt="Lolo Alvarez D&iacute;az">
		...
		<div class="emms22__partners">
			<div class="emms22__container--md">
				...
				<ul class="emms22__partners_list">
					...
					<li class="emms22__fade-in"><img src="./html/img/logo-banco-frances.png" alt="Banco Franc&eacute;s"></li>
