				...
				<div class="emms22__hero-pre-event__intro">
					<div class="emms22__hero-pre-event__intro__info">
                        ...
                        <p class="emms22__hero-pre-event__intro__info__add">
                            <img src="../../common/html/img/icon-hotel.png" alt="icon-hotel">
                            <img src="../../common/html/img/icon-bell.png" alt="icon-bell">
                            <strong>Con tu registro, estás participando por una estadía de fin de semana para 2 personas. Mira términos y condiciones <a href="../../common/html/img/Sorteo-Doppler-Terminos-Condiciones.pdf" download="Sorteo Doppler Terminos y Condiciones.pdf">aquí</a>.</strong></p>
					</div>
